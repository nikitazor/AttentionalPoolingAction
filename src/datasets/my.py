...
_FILE_PATTERN = 'pancreas_%s.tfrecord'

SPLITS_TO_SIZES = {'trainval_train': 3003, 'trainval_val': 709,
                   'trainval': 3712,  # 8219 + 6988
                   'test': 828}

_NUM_CLASSES = 4  # activities

_NUM_POSE_KEYPOINTS = 0
